...
import com.cursoandroid.organizzeapp.activity.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    private double despesaTotal, receitaTotal, resumoUsuario;
    ...
    public void configuraCalendarView(){
        ...
        /*calendarView.state().edit()
                ...
                .setMaximumDate(CalendarDay.from(2022, 3, 1))
                .commit();
        ...
        CharSequence dias[] = {"Seg", "Ter", "Qua", "Qui", "Sex", "Sáb", "Dom"};
